...
namespace NPCChat.Core.DialogueClasses
{
    ...
    {
        public IReadOnlyList<DialoguePoolEntry> Entries { get; init; } = [];
    ...
    public sealed class DialoguePoolEntry
    {
        ...
        /// </summary>
        public float[] MoodVector { get; init; } = [];
        ...
        /// </summary>
        public Dictionary<string, MinMax> Requires { get; init; } = new(StringComparer.OrdinalIgnoreCase);

        /// <summary>
        /// Stat forbids: if any passes, the entry is excluded.
        /// </summary>
        public Dictionary<string, MinMax> Forbids   { get; init; } = new(StringComparer.OrdinalIgnoreCase);
        ...
        public CooldownSpec Cooldown { get; init; } = new();
